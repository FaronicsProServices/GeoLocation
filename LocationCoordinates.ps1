# Retrieve the current geographic location (latitude and longitude) of the system
...
$latitude_and_longitude.Start() # Begin resolving current location
...
if ($latitude_and_longitude.Permission -eq 'Denied'){
    ...
    $latitude_and_longitude.Position.Location | Select Latitude,Longitude # Select the relevant results.
}
